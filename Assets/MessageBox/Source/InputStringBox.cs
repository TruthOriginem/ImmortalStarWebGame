...
public class InputStringBox : ModalBox
{
    /// <summary>
    ...
    public static string PrefabResourceName = "InputString Box";
    ...
    DialogResult result;
    string output;
    Action<DialogResult, string> onFinish;
    ...
    public static InputStringBox Show(string message, Action<DialogResult, string> onFinished, MessageBoxButtons buttons = MessageBoxButtons.OK)
    {
    ...
    /// <param name="buttons">Selects what buttons are shown on the dialog.</param>
    /// <returns>The message box game object.</returns>
    public static InputStringBox Show(string message, string title = null, Action<DialogResult, string> onFinished = null, MessageBoxButtons buttons = MessageBoxButtons.OK)
    {
        var box = (Instantiate(Resources.Load<GameObject>(PrefabResourceName)) as GameObject).GetComponent<InputStringBox>();
